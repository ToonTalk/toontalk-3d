...
M_IRIS  = mat("dusty_iris", IRIS_NAVY, rough=0.18, emit=(0.12, 0.38, 0.95, 1), emit_str=0.35)
...
for s2, nm in ((-1, "L"), (1, "R")):
    ...
    ball("iris_" + nm, 0.029, (0.079 * s2, -0.208, 0.301), M_IRIS, parent=body)
    ball("spark_" + nm, 0.012, (0.090 * s2, -0.226, 0.315), M_WHITE, parent=body)
