...
RUN = ('TO RUN IT\n\n'
       ...
       'number written twice. So this\n'
       'walk COVERS every fraction --\n'
       'some more than once. A count\n'
       'that gives each fraction ONE\n'
       'step needs the repeats taken\n'
       'out (the original set has a\n'
       'No Copies robot for that: it\n'
       'tests whether n/d is already\n'
       'in lowest terms). Is the count\n'
       'wrong with repeats in, or only\n'
       'untidy?\n\n'
