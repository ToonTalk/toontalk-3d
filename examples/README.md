...
| [`lessons/`](lessons/) | 🪐 a step-and-turn planet, 🌸 an easy flower, ✨ a jumping spark: three small drawing lessons written by ChatGPT -- one team, one labelled work box, a finisher that recognises zero -- with the same teams as helper cards; the flower's spokes are in invisible ink |
