"""Dusty the vacuum, v8 -- a character rather than an appliance.
...
M_SUCK  = mat("dusty_suck", (0.06, 0.35, 0.45, 1), rough=0.15, emit=CYAN, emit_str=3.4)
...
ball("gulp", 0.072, (0, -0.140, 0.146), M_SUCK, parent=body, scale=(1.06, 0.46, 0.42))
...
for s2, nm in ((-1, "L"), (1, "R")):
    ...
    # something off.
    cyl("arm_" + nm, 0.019, 0.055, (0.183 * s2, -0.060, 0.166), M_DARK, bevel=0.007,
        parent=body, rot=(0, math.radians(66 * s2), math.radians(-18 * s2)))
    torus("cuff_" + nm, 0.026, 0.009, (0.204 * s2, -0.078, 0.158), M_DARK, parent=body,
          rot=(0, math.radians(66 * s2), 0))
    ball("mitt_" + nm, 0.045, (0.219 * s2, -0.092, 0.150), M_CREAM, parent=body,
         scale=(0.92, 1.08, 0.80))
...
ball("bag", 0.118, (0, 0.163, 0.272), M_CREAM, parent=body, scale=(0.94, 0.80, 0.96))
torus("bag_strap", 0.104, 0.017, (0, 0.140, 0.272), M_DARK, parent=body,
      rot=(math.radians(90), 0, math.radians(90)))
cyl("bag_window", 0.040, 0.020, (0, 0.253, 0.286), M_GLOW, parent=body,
