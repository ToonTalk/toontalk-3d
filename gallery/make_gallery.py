...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .legend {{ font: 13px/2.1 system-ui, sans-serif; color: var(--dim); }}   /* room for the chips: at 1.5 they touched the line above (Ken) */
  .legend .do {{ margin: 0 4px; vertical-align: baseline; }}
