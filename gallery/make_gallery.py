...
ROUTE = [
  ...
  ('accounts/🏦 bank-account', 'Houses and state',
   ...
   ['accounts/💰 account'], 'Drop a request on the bird marked “requests”: the Teller inside answers with a slip, and the balance stays out of reach.',
  ...
  ('images/🖼️ pictures', 'Houses and state',
   ...
   ['behaviours/🏃 moving'], 'Look; then give the pictures the letters on the table: each one changes the way any pad would.',
  ...
  ('infinity/♾️ activity6-all-rationals', 'Infinity',
   ...
   ['infinity/♾️ activity5-above-one'], 'Pull the lever on the All Fractions room: the five rooms wake in turn and the merged nest fills with every rational.',
  ...
  ('infinity/♾️ activity7-any-interval', 'Infinity',
   ...
   ['infinity/♾️ activity6-all-rationals'], 'Pull the lever on the All Fractions room: three nests fill at exactly the same rate.',
