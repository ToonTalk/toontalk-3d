"""Dusty the vacuum, v4 -- a character rather than an appliance.
...
torus("bumper", 0.190, 0.036, (0, 0, 0.036), M_DARK, parent=root)
ball("belly", 0.130, (0, -0.150, 0.130), M_CREAM, parent=body, scale=(1.0, 0.30, 0.78))
...
ball("mouth", 0.108, (0, -0.132, 0.152), M_DARK, parent=body, scale=(1.20, 0.36, 0.60))
ball("gulp", 0.086, (0, -0.150, 0.150), M_GLOW, parent=body, scale=(1.16, 0.24, 0.46))
...
for s2, nm in ((-1, "L"), (1, "R")):
    cyl("arm_" + nm, 0.022, 0.060, (0.198 * s2, -0.02, 0.200), M_DARK, bevel=0.008,
        parent=body, rot=(0, math.radians(72 * s2), 0))
    ball("mitt_" + nm, 0.048, (0.232 * s2, -0.02, 0.186), M_CREAM, parent=body,
         scale=(1, 0.94, 0.88))
